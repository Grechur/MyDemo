package com.clock.zc.mydemo.view.smart.impl;
...
public class RefreshFooterWrapper implements RefreshFooter {
    ...
    public SpinnerStyle getSpinnerStyle() {
        if(this.mSpinnerStyle != null) {
            ...
            if(params instanceof com.clock.zc.mydemo.view.smart.SmartRefreshLayout.LayoutParams) {
                this.mSpinnerStyle = ((com.clock.zc.mydemo.view.smart.SmartRefreshLayout.LayoutParams)params).spinnerStyle;
                if(this.mSpinnerStyle != null) {
                    return this.mSpinnerStyle;
                }
            }
    ...
    public void onInitialized(RefreshKernel kernel, int height, int extendHeight) {
        LayoutParams params = this.mWrapperView.getLayoutParams();
        if(params instanceof com.clock.zc.mydemo.view.smart.SmartRefreshLayout.LayoutParams) {
            kernel.requestDrawBackgoundForFooter(((com.clock.zc.mydemo.view.smart.SmartRefreshLayout.LayoutParams)params).backgroundColor);
        }
