...
import com.clock.zc.mydemo.view.smart.PagerAdapterWrapper;
...
import com.clock.zc.mydemo.view.smart.util.ScrollBoundaryUtil;
    ...
    public void setupComponent(RefreshKernel kernel, View fixedHeader, View fixedFooter) {
        ...
        if(fixedHeader != null || fixedFooter != null) {
            ...
            if(fixedFooter != null) {
                ...
                android.widget.FrameLayout.LayoutParams flp = new android.widget.FrameLayout.LayoutParams(lp);
