...
public class ServiceManager {
    ...
    public void onStart(Intent proxyIntent, int startId) {
        ...
        Intent targetIntent = proxyIntent.getParcelableExtra("oldIntent");
    ...
    public int stopService(Intent targetIntent) {
        ...
        if (mServiceMap.isEmpty()) {
            ...
            Context appContext = DemoApplication.AppContext;
            appContext.stopService(new Intent().setComponent(new ComponentName(appContext.getPackageName(), MyIntentService.class.getName())));
        }
        return 1;
    }
    ...
    private void proxyCreateService(ServiceInfo serviceInfo) throws Exception {
        ...
        serviceInfo.applicationInfo.packageName = DemoApplication.AppContext.getPackageName();
