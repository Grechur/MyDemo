...
public class QQNaviView extends LinearLayout {
    ...
    /* 显示数字的小红点 */
    private QQBezierView mRedIcon;

    /* 显示数字的小红点数字 */
    private String mText;

    /* 显示数字的小红点icon资源*/
    private int mRedIconSrc;
    ...
    public QQNaviView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mRedIconSrc = ta.getResourceId(R.styleable.QQNaviView_redicon, R.mipmap.red_bg);
        mBigIconSrc = ta.getResourceId(R.styleable.QQNaviView_bigIconSrc, R.mipmap.big);
        mSmallIconSrc = ta.getResourceId(R.styleable.QQNaviView_smallIconSrc, R.mipmap.small);
    ...
    private void init(Context context) {
        ...
        mRedIcon = (QQBezierView) mView.findViewById(R.id.qq_point);

        mBigIcon.setImageResource(mBigIconSrc);
        mSmallIcon.setImageResource(mSmallIconSrc);
        mRedIcon.setBackgroundResource(mRedIconSrc);
    ...
    private void setupView() {
        ...
        mRedIcon.setText(mText);
        mRedIcon.setOnDragListener(new QQBezierView.onDragStatusListener() {
            @Override
            public void onDrag() {
